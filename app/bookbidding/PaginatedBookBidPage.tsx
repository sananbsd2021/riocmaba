        ...
        <table className="min-w-full table-auto border-collapse border border-gray-200 shadow-md">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="px-4 py-2 border border-gray-200 text-left">ที่คำสั่ง</th>
          ...
          <tbody>
            {posts.map((post, index) => (
              <tr key={post.numbid} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-2 border border-gray-200">{post.numbid}</td>
...
export default PaginatedBookBidPage;
